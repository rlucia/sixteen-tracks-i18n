...
recover: Menü nicht aufgegangen? Probier stattdessen [FUNC] + [TRIG], die Kombination, die §10.4 für dasselbe Menü gibt, wo §10.8 [FUNC] + [KEYBOARD G#1] gibt; welche der beiden es annimmt, klärt dein Gerät. Ganz hochgedreht und den späten Clap verloren? Geh zurück auf den Subtrack des Claps, halte [TRIG 7] und drücke [RIGHT], um sie wieder herauszuschieben (§10.5); Quantisieren rundet auf den nächsten Schritt, und für einen Trig mit Micro-Timing muss das nicht der Schritt sein, auf dem er geschrieben wurde (§10.8). Und klingt die Aufnahme immer noch nicht wie das, was du gespielt hast, bildest du dir das nicht ein: [ein Besitzer berichtet dasselbe](https://www.elektronauts.com/t/tonverk-user-thread/238631/1812), ohne Antwort im Thread.
:::
